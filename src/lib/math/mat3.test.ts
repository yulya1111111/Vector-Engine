import {Mat3, mat3} from '../math/mat3.ts'
...
test("multiply: black-box property using points (A*B acting like A after B)", () => { const A = mat3.fromTransform(5, 7, 0.2, 1.5, 0.8);
...
// {
//     const I = mat3.identity(); // единичная матрица
//     const a = mat3.translate(10, 5);
//     const result = mat3.multiply(a, I);
//
//     console.log(result[2] === 10 && result[5] === 5, "MultiplyTest");
// }
//
// function Rotate0Test() 
// {
//     const r0 = mat3.rotate(0);
//    
//     console.assert(r0[0] === 1 && r0[4] === 1, "rotate(0) = identity");
// }
//
// function Rotate90Test() 
// {
...
//     // (1, 0) → (0, 1)
//     console.assert(
//         Math.abs(p_rotated.x - 0) < 0.001,
//         "rotate 90° от (1,0) должна дать x≈0"
//     );
//     console.assert(
//         Math.abs(p_rotated.y - 1) < 0.001,
//         "rotate 90° от (1,0) должна дать y≈1"
//     );
//
// }
//
// function InvertTest() 
// {
//     const m = mat3.translate(10, 20);
//     const m_inv = mat3.invert(m);
//    
//     if (m_inv) 
//     {
//         const identity = mat3.multiply(m, m_inv);
//
//         // identity должна быть близка к [1,0,0, 0,1,0, 0,0,1]
//         const is_identity = Math.abs(identity[0] - 1) < 0.001
//             && Math.abs(identity[4] - 1) < 0.001;
//        
//         console.assert(is_identity, "M × M^{-1} должна быть identity"); 
//     }
// }
//
// function FromTransformTest() 
// {
//     const m = mat3.fromTransform(100, 50, Math.PI / 4, 2, 1);
//     // Точка (1, 0) в local
//     // После масштаба: (2, 0)
//    
//     // После поворота 45°: (√2, √2) ≈ (1.414, 1.414)
//     // После трансляции: (101.414, 51.414)
//     const p = mat3.transformPoint(m, 1, 0);
//     console.log("Результат:", p);
//     // Должно быть примерно {x: 101.414, y: 51.414}
// }
//
// function TransformPoint()
// {
//     const M = [2,0,5, 0,3,7, 0,0,1] as Mat3;
//     const p = mat3.transformPoint(M, 1, 1); // { x: 2*1 + 0*1 + 5 = 7, y: 0*1 + 3*1 + 7 = 10 }
//     console.assert(p.x === 7 && p.y === 10);
// }
//
// MultiplyTest();
// Rotate0Test();
